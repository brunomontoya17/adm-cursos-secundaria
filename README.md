...
Pasos **0–7** del [roadmap](docs/roadmap.md): shell, escuelas/materias/año lectivo, cursos, alumnos, horarios, evaluaciones, notas y asistencia. Schema `database.sql` **v1.2**. Siguiente: calendario (eventos).
