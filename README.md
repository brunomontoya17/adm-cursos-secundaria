...
Pasos **0–8** del [roadmap](docs/roadmap.md): shell, escuelas/materias/año lectivo, cursos, alumnos, horarios, evaluaciones, notas, asistencia y calendario (eventos). Schema `database.sql` **v1.2**. Siguiente: observaciones. Icono de la app: sello del logo (no el default de Tauri).
