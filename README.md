...
Pasos **0–6** del [roadmap](docs/roadmap.md): shell, escuelas/materias/año lectivo, cursos, alumnos, horarios, evaluaciones y notas. Schema `database.sql` **v1.2**. Siguiente: asistencia.
